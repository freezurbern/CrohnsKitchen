    ...
    <script>
        $(document).ready(function () {
            ...
            if (pagetitle) {
                ...
                document.title = 'Crohn\'s Kitchen';
            }
        })
    </script>
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#" class="ckorangetxt cklightbg"
                       style="cursor: default !important;"><?php require($_SERVER['DOCUMENT_ROOT'] . "/sitenotice.txt"); ?><span
                            class="sr-only">(current)</span></a></li>
                <?php if (isset($_SESSION['email'])) { ?>
                    <li class="dropdown active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">User<span
                                class="caret"></span></a>
                ...
                <?php } else { ?>
                    <li><a href="/user/login.php" class="btn-xs btn-primary" style="color: white !important;">Login<span class="sr-only">(current)</span></a>
                    </li>
                <?php } ?>
            </ul>
        </div><!--/.nav-collapse -->
