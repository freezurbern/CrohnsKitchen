...
<body class="main-page" onload="curPage()" >
		...
		<div id="nav">
			...
			<a href="add-food.php" id="nav-food" class="button food-navlink">Add Food</a>
			<a href="research.php" id="nav-research" class="button research-navlink">Research</a>
		</div>
