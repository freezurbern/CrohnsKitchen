...
<head>
  ...
  <nav class="navbar navbar-default">
	  <div class="container-fluid">
		...
		<a class="navbar-brand ck-byline" href="/index.php"><img alt="BrandIcon" src="/favicon.ico" width="25" height="25" style="display: inline; margin-top: -5px; margin-right: 5px;">Crohn's Kitchen</a>
		</div>
		...
		<ul class="nav navbar-nav navbar-right">
			<li><a href="" onclick='window.alert("Not yet operational. Thank you for your interest.")'>Donate</a></li>
			<li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php if (isset($ul) && $ul == true) {echo 'Signed in as '.$un;} else {echo "Profile";}?>
